...
| 5.5 | bitable-schema 内联 | 多维表格字段定义从独立文件内联到子代理 prompt，减少文件依赖 |
...
### bitable-schema 内联
将多维表格字段定义从独立的 `references/bitable-schema.md` 内联到 `prompts/java-code-reviewer.md` 中：
- 减少子代理的文件读取次数
- 完整字段配置 JSON 直接嵌入 prompt，子代理可直接复制使用
